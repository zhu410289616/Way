...
- (void)installGestureListener
{
    ...
    if (nil == _singleTapGesture) {
        _singleTapGesture = [[UITapGestureRecognizer alloc] initWithTarget:self action:@selector(doSingleTapAction:)];
        [_singleTapGesture requireGestureRecognizerToFail:_doubleTapGesture];
        [_mapView addGestureRecognizer:_singleTapGesture];
    }//if
}
...
- (void)doSingleTapAction:(UIGestureRecognizer *)gesture
{
    if (_delegate && [_delegate respondsToSelector:@selector(didSingleTapAction:)]) {
        [_delegate didSingleTapAction:gesture];
    }
}
...
- (void)uninstallGestureListener
{
    if (_singleTapGesture) {
        [_mapView removeGestureRecognizer:_singleTapGesture];
